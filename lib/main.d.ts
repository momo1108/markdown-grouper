 ...
 * @param {number} minLevel min level to start grouping (default: 1 -> \<h1>)
 * @param {number} maxLevel max level to start grouping (default: 6 -> \<h6>)
 ...
 */
declare function parseToGroup(markdownText:string, minLevel?:1|2|3|4|5|6, maxLevel?:1|2|3|4|5|6, selector?:string, prefix?:string, postfix?:string): string;
 ...
 * @returns {string} html text data grouped by section tag
 */
declare function parseFileToGroup(markdownPath:string, minLevel?:1|2|3|4|5|6, maxLevel?:1|2|3|4|5|6, selector?:string, prefix?:string, postfix?:string): string;
...
declare class MarkdownDocument {
     ...
     * @param minLevel min level to start grouping (default: 1 -> \<h1>)
     * @param maxLevel max level to start grouping (default: 6 -> \<h6>)
     ...
     * @returns void
     */
    public setDocument: (isPath:boolean, markdownText:string, minLevel?:1|2|3|4|5|6, maxLevel?:1|2|3|4|5|6, order?:number, prevLabel?:string, selector?:string, prefix?:string, postfix?:string, cli?:boolean) => void;
